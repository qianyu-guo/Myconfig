...
" 新建tab  由原先的Ctrl+t变成了<leader>ttt
" nnoremap <C-t>     :tabnew<CR>
" inoremap <C-t>     <Esc>:tabnew<CR>
nnoremap <leader>ttt     :tabnew<CR>
inoremap <leader>ttt    <Esc>:tabnew<CR>
...
nnoremap <leader>v V`}
" 去掉快选择或者选择高亮
nnoremap <leader>e <Esc>:nohls<CR>
vnoremap <leader>e <Esc>:nohls<CR>
...
autocmd BufNewFile *.sh,*.py,*.c,*.cpp,*.h,.java  exec ":call AutoSetFileHead()"
...
" 设置vim终端背景色
" 第一个 ctermfg 是没有被 hightlight 的文字颜色。第二个 ctermbg 是背景色，你可
" 以用关键字设置，也可以用颜色码。
